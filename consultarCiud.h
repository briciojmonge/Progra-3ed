...
namespace progra3ED {
	...
	/// <summary>
	/// Summary for consultarCiud
	/// </summary>
	public ref class consultarCiud : public System::Windows::Forms::Form
	{
	public:
		consultarCiud(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Consulta de Ciudades";
			this->label1->Click += gcnew System::EventHandler(this, &consultarCiud::label1_Click);
			// 
			// label2
			// 
			...
			this->label2->Size = System::Drawing::Size(410, 22);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Ingrese el código del país de la ciudad:";
			// 
			// label3
			// 
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(20, 96);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(20, 178);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Consolas", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(460, 221);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(130, 59);
			this->button1->TabIndex = 5;
			this->button1->Text = L"Buscar";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &consultarCiud::button1_Click);
			// 
			// consultarCiud
			// 
			...
			this->ClientSize = System::Drawing::Size(618, 296);
			...
			this->Name = L"consultarCiud";
			this->Text = L"Consulta de Ciudades";
